...
dds <- readRDS(paste0("/N/slate/yosueda/20220208/Output/dds_HC.rds"))
...
write.csv(full.results.df, file = "/N/slate/yosueda/20220208/Output/DESeq2_HC.csv")
saveRDS(dds, "/N/slate/yosueda/20220208/Output/dds_HC_new.rds")
message("data saved")
